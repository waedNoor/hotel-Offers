...
public class HotelInfoDO extends AbstractDO{
	...
	private String hotelReviewTotal;
	...
	public String getHotelReviewTotal() {
		return hotelReviewTotal;
	}
	public void setHotelReviewTotal(String hotelReviewTotal) {
